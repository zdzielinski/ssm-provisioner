...
[Version v0.0.4](https://gitlab.com/zdzielinski/ssm-provisioner/-/tags/v0.0.4) - [Main GitLab Repository](https://gitlab.com/zdzielinski/ssm-provisioner) - [Secondary GitHub Mirror](https://github.com/zdzielinski/ssm-provisioner).
...
```bash
curl -sO https://gitlab.com/zdzielinski/ssm-provisioner/-/raw/v0.0.4/ssm-provisioner.sh
```
...
You can browse the latest releases in the [tags page](https://gitlab.com/zdzielinski/ssm-provisioner/-/tags), with more details in the [changelog page](./CHANGELOG.md).

## Contributing

If you'd like to help out, please read the [contributing page](./CONTRIBUTING.md).
